...
const TeacherChat: React.FC = () => {
  ...
  const getSenderName = (message: any) => {
    ...
    return message.profiles?.first_name || message.profiles?.username || 'Unknown User';
  };
      ...
      <div className="space-y-6">
        ...
        <Card className="max-w-3xl mx-auto h-[600px] flex flex-col shadow-lg rounded-lg">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-muted-foreground">Communicate with your students in real-time.</CardDescription>
          </CardHeader>
